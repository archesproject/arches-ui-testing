...
WebUI.click(findTestObject('Page_Arches 4.3 - Resource Manager (5)/button_Add'))

WebUI.click(findTestObject('Page_Arches 4.3 - Resource Manager (5)/span_Park Image'))

WebUI.click(findTestObject('Page_Arches 4.3 - Resource Manager (5)/span_Add files...'))
