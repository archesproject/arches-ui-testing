...
WebUI.uploadFile(findTestObject('Page_Arches 4.3 - Reference Data Ma (3)/div_Drop files here to upload'), '\\\\Users\\\\awuthrich\\\\Documents\\\\testimage.jpg')

FilePath = WebUI.getAttribute(findTestObject('Page_Arches 4.3 - Reference Data Ma (3)/a_Add images'), 'value')
