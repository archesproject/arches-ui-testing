...
WebUI.click(findTestObject('RDM Objects/Thesauri Objects/Creation/a_Add Thesauri'))

WebUI.delay(2)

WebUI.setText(findTestObject('RDM Objects/Thesauri Objects/Creation/input_label'), 'Test')

WebUI.click(findTestObject('RDM Objects/Thesauri Objects/Creation/button_Save changes'))
