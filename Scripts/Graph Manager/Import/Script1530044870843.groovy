...
WebUI.delay(2)
WebUI.click(findTestObject('Page_Arches 4.3 - Graphs (1)/i_ion-more'))

WebUI.uploadFile(findTestObject('Page_Arches 4.3 - Graphs (1)/a_Import BranchResource Model'), 'C:\\\\Users\\\\awuthrich\\\\Documents\\\\TestingModel.json')
